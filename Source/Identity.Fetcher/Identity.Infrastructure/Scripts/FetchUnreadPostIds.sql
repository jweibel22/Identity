...
select RowNum, PostId, PostClusterId into #MyTempTable from [ftFetchUnreadPosts](@ChannelId,@UserId,@OrderByColumn) where RowNum BETWEEN (@FromIndex) AND (@FromIndex+150) order by RowNum
DECLARE @MaxRow int
